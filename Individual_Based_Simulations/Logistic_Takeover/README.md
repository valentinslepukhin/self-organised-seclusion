The code included here (main-logistic_takeover.py) performs the simulations that produce the effect of logistic takeover, shown in Fig. 3C in the manuscript.
